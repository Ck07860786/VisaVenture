  ...
  useEffect(() => {
    const fetchAgents = async () => {
      try {
        ...
        setSearchResults(approvedAgents);  
      } catch (error) {
    ...
    <>
      ...
      >
        <div className="mt-24 flex flex-col items-center px-4">
          <Search setSearchResults={setSearchResults} /> {/* Pass the setSearchResults function here */}
              ...
              {searchResults.length > 0 ? (
                searchResults.map(agent => (
                  ...
                  >
                    ...
                    />
                    <h3 className="text-xl font-semibold flex items-center justify-center text-center text-gray-800">
                      {agent.name} <MdVerified className="ml-2 text-blue-500" />
                    </h3>
