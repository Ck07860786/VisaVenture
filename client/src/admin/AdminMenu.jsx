...
function AdminMenu() {
  ...
  <section classname=" mt-16 ">
    ...
    <aside id="separator-sidebar" className="fixed top-0 left-0 z-40 w-80 h-screen mt-8 transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
      <div className="h-full px-3 py-4 overflow-y-auto  shadow-lg dark:bg-gray-800 mt-10">
        <ul className="space-y-2 font-medium text-white">
          <li>
            <a href="#" className="flex items-center p-2 text-black rounded-lg hover:text-black hover:bg-gray-100 dark:hover:bg-gray-700 group">
          ...
          <li>
            <a href="#" className="flex items-center p-2 text-black rounded-lg hover:text-black dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
              ...
              <span className="flex-1 ms-3 whitespace-nowrap">Pro Agent</span>
        ...
        <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
          <li>
            <a href="#" className="flex items-center p-2  text-black hover:text-black transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
          ...
          <li>
            <a href="#" className="flex items-center p-2 t text-black hover:text-black transition duration-75 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">
